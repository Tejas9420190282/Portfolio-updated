...
import Doctor_Appointment_System_Project_Details from './pages/Doctor_Appointment_System_Project_Details'
...
function App() {
  ...
  const router = createBrowserRouter([
    ...
    {
      path : "/project-doctor-appointment-system-details",
      element : <><Doctor_Appointment_System_Project_Details /></>
    },
