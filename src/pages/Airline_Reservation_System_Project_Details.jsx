// Airline_Reservation_System_Project_Details.jsx
...
function Airline_Reservation_System_Project_Details() {
    const openLink = (url) => {
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-8">
                        <div className="bg-slate-800 p-6 sm:p-8 rounded-xl border border-slate-700">
                            ...
                            <div className="space-y-5 text-left">
                                ...
                                <InfoItem
                                    icon={Search}
                                    text="Advanced search by location, date, and availability"
                                />
                                <InfoItem
                                    icon={CreditCard}
                                    text="Ticket booking with Razorpay payment"
                                />
                                <InfoItem
                                    icon={FileText}
                                    text="PDF ticket generation"
                                />
                                <InfoItem
                                    icon={RotateCcw}
                            ...
                            <div className="space-y-5 text-left">
                                ...
                                <InfoItem
                                    icon={BarChart2}
                                    text="Booking overview & filtering"
                                />
                                <InfoItem
                                    icon={Users}
                        ...
                        <div className="flex flex-col sm:flex-row sm:space-x-5 gap-5">
                            <ActionButton
                                ...
                                onClick={() =>
                                    openLink(
                                        "https://github.com/Tejas9420190282/Airline_Reservation_System_NodeJs.git"
                                    )
                                }
                                bgColor="bg-gray-600"
                            ...
                            <ActionButton
                                ...
                                onClick={() =>
                                    openLink(
                                        "https://www.linkedin.com/posts/tejas-shimpi-459235206_react-nodejs-sql-activity-7302563386674802688-H5fX?utm_source=share&utm_medium=member_desktop&rcm=ACoAADRcD0UBPNVebS3NtCgLNQLXyWoK2-ZlglA"
                                    )
                                }
                                bgColor="bg-[#0A66C2]"
...
export default Airline_Reservation_System_Project_Details;
