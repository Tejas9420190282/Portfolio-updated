...
function Doctor_Appointment_System_Project_Details() {
                    ...
                    <div className="w-full lg:w-1/2 flex flex-col gap-8">
                        <div className="bg-slate-800 p-6 sm:p-8 rounded-xl border border-slate-700">
                            ...
                            <p className="text-left">
                                ...
                                users can search for available flights, book
                                tickets, and manage their bookings, while admins
                                can manage flights and view bookings.
                            </p>

                            <h3 className="text-2xl font-bold mb-6 text-gray-50 mt-5">
                                ✨ Key Features
                            </h3>
                                ...
                                <InfoItem
                                    ...
                                    text={
                                        <span>
                                            ...
                                            TailwindCSS, React.js, Node.js, Express.js, MySQL,
                                        </span>
                                    }
                                />

                                <h4 className="text-xl font-bold mt-8 mb-4 text-center text-cyan-400">
                                    ⚙️ User Features
                                </h4>
                                <InfoItem
                                    icon={User}
                                    text="Secure User Authentication (JWT + email verification)"
                                />
                                <InfoItem
                                    icon={Search}
                                    text="View list of available doctors and departments"
                                />
                                <InfoItem
                                    icon={CreditCard}
                                    text="Book an appointment with available time slots"
                                />
                                <InfoItem
                                    icon={FileText}
                                    text="View and manage your booked appointments"
                                />
                            ...
                            <div className="space-y-5 text-left">
                                ...
                                <InfoItem
                                    icon={Users}
                                    text="Add/edit/delete doctor profiles and departments"
                                />

                                <InfoItem
                                    icon={Users}
                                    text="View all booked appointments"
                                />
                        ...
                        <div className="flex flex-col sm:flex-row sm:space-x-5 gap-5">
                            ...
                            <ActionButton
                                            ...
                                            icon={FileTextIcon}
                                            onClick={() => openLink("https://documenter.getpostman.com/view/40699331/2sB2cYd1Ly")}
                            ...
                            <ActionButton
                                ...
                                onClick={() =>
                                    openLink(
                                        "https://www.linkedin.com/posts/tejas-shimpi-459235206_reactjs-nodejs-mysql-activity-7320799527387447296-cNUM?utm_source=share&utm_medium=member_desktop&rcm=ACoAADRcD0UBPNVebS3NtCgLNQLXyWoK2-ZlglA"
                                    )
                                }
                                bgColor="bg-[#0A66C2]"
...
export default Doctor_Appointment_System_Project_Details
